...
| V2.3.0 | 2026-07-13 | AI Coding Agent | 基于 POD CMP 门户截图完成 Portal UI 设计（design.md 新增 Portal UI Design 章节）：全局框架（顶部导航+左侧边栏）、仪表盘（6 Widgets 网格）、账户/用户/SIM/eSIM 列表与详情页布局 |
